...
The whole public website for Moonforge Games: the marketing and legal pages, plus
a Pixel Chronicles wiki generated from the Unity project itself. Nothing in the
wiki is hand-written — items, monsters, loot chances, recipes, item sets, buildings
and the Adventure chapters are read out of the ScriptableObjects and entity prefabs
